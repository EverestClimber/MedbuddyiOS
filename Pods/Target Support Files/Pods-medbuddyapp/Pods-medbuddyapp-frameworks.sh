...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/ACFloatingTextfield-Objc/ACFloatingTextfield_Objc.framework"
  install_framework "$BUILT_PRODUCTS_DIR/AFViewShaker/AFViewShaker.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ASJOverflowButton/ASJOverflowButton.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/PickerCells/PickerCells.framework"
